<?php 
 class RecaptchaComponent extends Component {
    var $publickey = "6LfeDtYSAAAAALfXG0SVuiq8q8KtnaGmIcIPA6Xu";
    var $privatekey= "6LfeDtYSAAAAAFT85oXfMUnOdjsd8qSL8W-ObYKw";
	var $theme= "red"; //theme options white, red, blackglass and clean
    ...
    function startup(&$controller){
		...
		$color = array('white','blackglass','red');
		shuffle($color);
		...
		Configure::write("Recaptcha.theme", $this->theme); //$color[0]
