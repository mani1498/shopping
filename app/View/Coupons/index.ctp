<div class="coupons index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('coupon_title'); ?></th>
			<th><?php echo $this->Paginator->sort('coupon_code'); ?></th>
			<th><?php echo $this->Paginator->sort('coupon_expire'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($coupon['Coupon']['coupon_title']); ?>&nbsp;</td>
		<td><?php echo h($coupon['Coupon']['coupon_code']); ?>&nbsp;</td>
		<td><?php echo h($coupon['Coupon']['coupon_expire']); ?>&nbsp;</td>
		<td><?php echo h($coupon['Coupon']['published_at']); ?>&nbsp;</td>
		<td><?php echo h($coupon['Coupon']['updated_at']); ?>&nbsp;</td>
		<td class="actions">
