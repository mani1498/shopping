...
<?php echo $this->Form->create('ProductVarient'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Product Varient'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProductVarient.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ProductVarient.id')))); ?></li>
